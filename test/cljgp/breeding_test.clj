...
(def typetest-tree-a
     (list (with-meta `count {:gp-type Number :gp-arg-types [:cljgp.test-helpers/seq]})
           (with-meta `TEXT {:gp-type :cljgp.test-helpers/string})))

(def typetest-tree-b
     (list (with-meta `safe-nth {:gp-type Number 
                                 :gp-arg-types [:cljgp.test-helpers/vector Number]})
           (with-meta `VECT {:gp-type :cljgp.test-helpers/vector})
